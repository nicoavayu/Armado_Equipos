                      ...
                      <PlayerMiniCard
                        ...
                        detailBadges={(
                          <div className="inline-flex items-center gap-1.5">
                            ...
                            {member.is_captain ? (
                              <span className="inline-flex min-w-[34px] items-center justify-center rounded bg-[linear-gradient(135deg,rgba(191,149,48,0.9),rgba(138,104,27,0.92))] px-2 py-1 text-[10px] font-bold text-[#fff1c8]">
                                CAP
                              </span>
                            ) : null}
                          </div>
