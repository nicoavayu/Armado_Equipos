...
const AcceptChallengeModal = ({
  ...
  return (
    <Modal
      ...
      className="w-full max-w-[520px] !rounded-none !border !border-[rgba(148,134,255,0.3)] !bg-[rgba(18,14,38,0.97)] !shadow-[0_26px_58px_rgba(0,0,0,0.62)]"
    ...
    >
      ...
      <select
        ...
        className="h-[44px] w-full rounded-none border border-[rgba(148,134,255,0.2)] bg-[rgba(20,16,41,0.92)] px-3 text-[15px] text-white outline-none focus:border-[#6a43ff] focus:ring-1 focus:ring-[#6a43ff]/45"
      >
