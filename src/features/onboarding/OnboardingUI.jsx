...
// (violet CTA gradient, flat surfaces, Inter type). Kept dependency-free
...
export function PrimaryButton({ children, className = '', ...props }) {
  return (
    <button
      ...
      className={`inline-flex h-[52px] w-full items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#8b5cff_0%,#6a43ff_52%,#5430e0_100%)] px-6 font-sans text-[15px] font-semibold normal-case tracking-[0.01em] text-white shadow-[0_10px_26px_rgba(106,67,255,0.4),inset_0_1px_0_rgba(255,255,255,0.22)] transition-transform duration-150 active:scale-[0.985] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#b0a0ff] disabled:opacity-60 motion-reduce:transition-none ${className}`}
      {...props}
    >
      {capitalizeInitial(children)}
    </button>
  );
}
