...
export default function FormularioNuevoPartidoFlow({ onConfirmar }) {
  ...
  const mainStyles = {
    minHeight: '100vh',
    width: '100vw',
    background: 'linear-gradient(180deg, #62c1ff 0%, #b579f8 100%)',
    overflowY: 'auto',
    display: 'flex',
              ...
              {['F5', 'F6', 'F7', 'F8', 'F9', 'F11'].map((tipo) => (
                <button
                  ...
                  style={{
                    ...
                    fontFamily: "'Oswald', Arial, sans-serif",
                    border: modalidad === tipo ? '2px solid #8178e5' : '1.5px solid #8178e5',
                    borderRadius: '6px',
                    background: modalidad === tipo ? '#8178e5' : 'rgba(255,255,255,0.9)',
