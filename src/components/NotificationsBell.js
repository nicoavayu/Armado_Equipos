  ...
  return (
    ...
    >
      ...
      {(unreadCount?.total || 0) > 0 && (
        <span className="absolute bottom-[6px] left-[6px] bg-primary w-2 h-2 rounded-full shadow-[0_2px_4px_rgba(0,0,0,0.3)] z-[100] md:bottom-2 md:left-2 md:w-[10px] md:h-[10px]"></span>
      )}
    </button>
  );
};
