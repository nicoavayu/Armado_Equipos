  ...
  return (
    <div className="relative bg-[#1e293b]/92 backdrop-blur-sm rounded-none p-5 min-h-[150px] border border-[#334155] transition-all duration-200 shadow-[0_10px_24px_rgba(0,0,0,0.28)] hover:border-[#4a7ed6] hover:brightness-[1.03]">
      ...
      <div className="flex gap-2 mt-2 items-stretch">
        <button
          className="flex-[1.6] font-bebas text-base px-4 py-2.5 border border-[#7d5aff] rounded-none cursor-pointer transition-all text-white min-h-[44px] flex items-center justify-center text-center sm:text-[13px] sm:px-3 sm:py-2 sm:min-h-[36px] bg-[#6a43ff] shadow-[0_0_14px_rgba(106,67,255,0.3)] hover:bg-[#7550ff]"
