...
const StatsView = ({ onVolver }) => {
  ...
  const statsPanelClass = 'bg-[linear-gradient(165deg,rgba(48,38,98,0.55),rgba(20,16,41,0.92))] border border-[rgba(148,134,255,0.18)] rounded-card shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_22px_rgba(5,3,16,0.4)]';
  const statsSubPanelClass = 'rounded-2xl border border-[rgba(148,134,255,0.2)] bg-[rgba(20,16,41,0.8)]';
    ...
    <div className="min-h-[100dvh]">
      ...
      <div className="pt-[81px] max-w-[100vw] m-0 box-border md:pt-[73px]">
        <motion.div
          ...
          className="relative z-40 overflow-visible border-y border-[rgba(148,134,255,0.2)] bg-[#171231]/92"
          ...
          <div className="grid grid-cols-3 gap-0">
            {['week', 'month', 'year'].map((p) => (
              <div key={p} className="relative min-w-0">
                <button
                  className={`relative w-full h-[44px] border-r border-[rgba(148,134,255,0.2)] last:border-r-0 px-2 font-bebas text-[0.95rem] tracking-[0.04em] transition-[background-color,color] duration-150 ${period === p ? 'bg-[linear-gradient(135deg,#7d52ff_0%,#6a43ff_60%,#5832e6_100%)] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]' : 'bg-[#171231]/92 text-white/65 hover:text-white/88 hover:bg-[rgba(48,38,98,0.9)]'}`}
                  onClick={() => {
                    setPeriod(p);
                ...
                {p === 'week' && showWeekDropdown && period === 'week' && (
                  <div className="absolute top-full left-0 right-0 bg-[#171231]/98 rounded-2xl border border-[rgba(148,134,255,0.2)] z-[1200] mt-1 max-h-[240px] overflow-y-auto backdrop-blur-md md:max-h-[150px] shadow-[0_10px_24px_rgba(2,10,34,0.46)]">
                    {getAvailableWeeks().map((week) => (
                      <div
                        key={week.index}
                        className={`px-4 py-3 text-white/80 cursor-pointer transition-all font-oswald text-sm hover:bg-[rgba(48,38,98,0.9)] hover:text-white ${selectedWeek === week.index ? 'bg-[rgba(106,67,255,0.22)] text-white font-semibold' : ''}`}
                        onClick={() => {
                ...
                {p === 'year' && showYearDropdown && period === 'year' && (
                  <div className="absolute top-full left-0 right-0 bg-[#171231]/98 rounded-2xl border border-[rgba(148,134,255,0.2)] z-[1200] mt-1 max-h-[200px] overflow-y-auto backdrop-blur-md md:max-h-[150px] shadow-[0_10px_24px_rgba(2,10,34,0.46)]">
                    {getAvailableYears().map((year) => (
                      <div
                        key={year}
                        className={`px-4 py-3 text-white/80 cursor-pointer transition-all font-oswald text-sm hover:bg-[rgba(48,38,98,0.9)] hover:text-white ${selectedYear === year ? 'bg-[rgba(106,67,255,0.22)] text-white font-semibold' : ''}`}
                        onClick={() => {
                ...
                {p === 'month' && showMonthDropdown && period === 'month' && (
                  <div className="absolute top-full left-0 right-0 bg-[#171231]/98 rounded-2xl border border-[rgba(148,134,255,0.2)] z-[1200] mt-1 max-h-[200px] overflow-y-auto backdrop-blur-md md:max-h-[150px] shadow-[0_10px_24px_rgba(2,10,34,0.46)]">
                    {monthNames.map((month, index) => (
                      <div
                        key={index}
                        className={`px-4 py-3 text-white/80 cursor-pointer transition-all font-oswald text-sm hover:bg-[rgba(48,38,98,0.9)] hover:text-white ${selectedMonth === index ? 'bg-[rgba(106,67,255,0.22)] text-white font-semibold' : ''}`}
                        onClick={() => {
            ...
            {stats.lesionesDetallePeriodo.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {stats.lesionesDetallePeriodo.map((lesion) => (
                  <div key={lesion.id} className="bg-[rgba(20,16,41,0.8)] border border-[rgba(148,134,255,0.2)] rounded-2xl px-3 py-2">
        ...
        <div className="mb-3">
          <motion.button
            className="w-full min-h-[44px] px-4 py-2.5 rounded-xl border border-white/20 bg-cta-gradient text-white font-bebas text-base tracking-[0.01em] flex items-center justify-center gap-2 transition-all duration-200 hover:brightness-105 active:scale-[0.985] shadow-cta sm:text-[13px] sm:px-3 sm:py-2 sm:min-h-[36px]"
        ...
        >
          ...
          {injuryStatus?.type === 'active' && (
            <button
              className="mt-3 w-full min-h-[44px] px-4 py-2.5 rounded-xl border border-white/20 bg-cta-gradient text-white font-bebas text-base tracking-[0.01em] transition-all duration-200 hover:brightness-105 active:scale-[0.985] shadow-cta sm:text-[13px] sm:px-3 sm:py-2 sm:min-h-[36px]"
        ...
        <motion.button
          className="w-full mb-6 min-h-[44px] px-4 py-2.5 rounded-xl border border-[rgba(148,134,255,0.28)] bg-white/[0.05] text-white/92 font-bebas text-base tracking-[0.01em] flex items-center justify-center gap-2 transition-all duration-200 hover:bg-white/[0.1] hover:border-[rgba(148,134,255,0.45)] sm:text-[13px] sm:px-3 sm:py-2 sm:min-h-[36px]"
        ...
        {showResultsRecap && (
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-2 sm:grid-cols-2">
              <div className="rounded-2xl border border-emerald-300/25 bg-emerald-400/10 px-3 py-2 text-center min-h-[82px] flex flex-col items-center justify-center">
              ...
              <div className="rounded-2xl border border-amber-300/25 bg-amber-400/10 px-3 py-2 text-center min-h-[82px] flex flex-col items-center justify-center">
              ...
              <div className="rounded-2xl border border-rose-300/25 bg-rose-400/10 px-3 py-2 text-center min-h-[82px] flex flex-col items-center justify-center">
              ...
              <div className="rounded-2xl border border-sky-300/25 bg-sky-400/10 px-3 py-2 text-center min-h-[82px] flex flex-col items-center justify-center">
        ...
        >
          <div className={`${statsPanelClass} p-4`}>
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              ...
              <div className="rounded-2xl border border-rose-300/25 bg-rose-400/10 px-3 py-2">
              ...
              <div className="rounded-2xl border border-emerald-300/25 bg-emerald-400/10 px-3 py-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="rounded-2xl border border-rose-300/20 bg-rose-400/5 px-2.5 py-2 text-center">
              ...
              <div className="rounded-2xl border border-sky-300/20 bg-sky-400/5 px-2.5 py-2 text-center">
              ...
              <div className="rounded-2xl border border-amber-300/20 bg-amber-400/5 px-2.5 py-2 text-center">
          ...
          <div className={`${statsPanelClass} p-4`}>
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              ...
              <div className="rounded-2xl border border-sky-300/25 bg-sky-400/10 px-3 py-2">
          ...
          {Array.isArray(rankingTimeline.movimientos) && rankingTimeline.movimientos.length > 0 ? (
            <div className="flex flex-col gap-2">
              {rankingTimeline.movimientos.slice(0, 6).map((mov) => (
                <div key={mov.id} className="flex items-center justify-between gap-2 rounded-2xl border border-[rgba(148,134,255,0.2)] bg-[rgba(20,16,41,0.8)] px-3 py-2">
          ...
          >
            ...
            <AnimatePresence>
              {stats.topAmigos.map((amigo, index) => (
                <motion.div
                  key={amigo.nombre}
                  className="relative flex items-center gap-4 bg-[#171231]/92 rounded-2xl p-4 mb-3 backdrop-blur-md border border-[rgba(148,134,255,0.2)] transition-all hover:translate-x-2 hover:border-[rgba(148,134,255,0.45)] hover:brightness-[1.03] md:p-3 md:gap-3"
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: 1.3 + index * 0.1 }}
                >
                  {index === 0 && (
                    <div className="absolute right-3 top-3 inline-flex items-center gap-1.5 rounded-2xl border border-[#ffd700]/30 bg-[#ffd700]/18 px-2.5 py-1 font-oswald text-[11px] font-semibold uppercase tracking-wide text-[#ffd700] md:right-2 md:top-2">
                      <Trophy size={14} />
                      Top Friend
                    </div>
                  )}
        ...
        {stats.partidosJugados === 0 && (
          <motion.div
            className="text-center p-10 bg-[#171231]/92 rounded-2xl backdrop-blur-md border border-[rgba(148,134,255,0.2)]"
            initial={{ opacity: 0, scale: 0.9 }}
            animate={{ opacity: 1, scale: 1 }}
          >
