...
const GoogleAuth = ({ user, className, disabled = false, loading = false, onStart, onEnd, returnTo = '/home' }) => {
  ...
  return (
    <button type="button" onClick={signInWithGoogle} className={className || 'google-sign-in-btn'} disabled={disabled}>
