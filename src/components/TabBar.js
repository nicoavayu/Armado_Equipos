...
const TabBar = ({ activeTab, onTabChange }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex h-[70px] md:h-[80px] z-[1000] bg-white/10 backdrop-blur-[20px] border-t border-white/20 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_32px_rgba(0,0,0,0.3)]">
      {/* Home */}
      <button
      ...
      >
        ...
        <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest font-bebas mt-1">Inicio</span>
      </button>
      ...
      >
        ...
        <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest font-bebas mt-1">Quiero Jugar</span>
      </button>
      ...
      >
        ...
        <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest font-bebas mt-1">Amigos</span>
      </button>
      ...
      >
        ...
        <span className="text-[10px] md:text-xs font-bold uppercase tracking-widest font-bebas mt-1">Perfil</span>
      </button>
    </div>
  );
};
