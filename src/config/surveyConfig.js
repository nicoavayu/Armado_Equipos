...
export const SURVEY_START_DELAY_MS = Number(process.env.REACT_APP_SURVEY_START_DELAY_MS) || 60 * 60 * 1000;
...
export const SURVEY_MIN_VOTERS_FOR_AWARDS = Number(process.env.REACT_APP_SURVEY_MIN_VOTERS_FOR_AWARDS) || 3;
export const SURVEY_MIN_VOTERS_IMMEDIATE_FINALIZE = Number(process.env.REACT_APP_SURVEY_MIN_VOTERS_IMMEDIATE_FINALIZE) || 3;
