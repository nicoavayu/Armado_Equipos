    ...
    <>
      ...
      {showArmarEquiposView ? (
        ...
        <>
          ...
          {/* MatchInfoSection arriba para no-admin */}
          {!isAdmin && (
            <div style={{ marginTop: isPlayerInMatch ? '-162px' : '-110px', marginBottom: '8px' }}>
              <MatchInfoSection
          ...
          <main className="page-body">
            {/* MatchInfoSection en posición original para admin */}
            {isAdmin && (
              <MatchInfoSection
                fecha={partidoActual?.fecha}
                hora={partidoActual?.hora}
          ...
          <>
            ...
            {/* Players list section - Solo mostrar en admin */}
            {isAdmin && (
