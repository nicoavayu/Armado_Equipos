...
const SEGMENT_BUTTON_BASE_CLASS = 'h-[44px] px-2 text-[16px] font-semibold font-oswald rounded-none ui-flat transition-all border flex items-center justify-center';
