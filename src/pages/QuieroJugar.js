            ...
            {freePlayers.length === 0 ? (
              ...
              <>
                <div className="flex gap-2 mb-4 w-full max-w-[500px]">
                  <button
                    className={`flex-1 py-2 rounded-none ui-flat text-[11px] font-bold tracking-wide cursor-pointer transition-all duration-300 uppercase border ${sortBy === 'distance'
                  ...
                  <button
                    className={`flex-1 py-2 rounded-none ui-flat text-[11px] font-bold tracking-wide cursor-pointer transition-all duration-300 uppercase border ${sortBy === 'rating'
                      ? 'bg-white/10 text-white border-white/30'
                      : 'bg-transparent text-white/40 border-white/10 hover:bg-white/5'
                      }`}
                  ...
                  <button
                    className={`flex-1 py-2 rounded-none ui-flat text-[11px] font-bold tracking-wide cursor-pointer transition-all duration-300 uppercase border ${sortBy === 'position'
                      ? 'bg-white/10 text-white border-white/30'
                      : 'bg-transparent text-white/40 border-white/10 hover:bg-white/5'
                      }`}
