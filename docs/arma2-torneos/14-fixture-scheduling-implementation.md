...
fuente estructurada: participante, posición de grupo, mejor clasificado,
ganador/perdedor de otro partido o bye. Los triggers comprueban el alcance y
rechazan referencias cíclicas.
...
`TorneosFixtureProvider` descarta respuestas obsoletas cuando cambia torneo o
categoría. La interfaz usa únicamente el contexto persistido, expone un flujo
...
cero. Cubre los cinco formatos, idempotencia, sorteo repetible, publicación,
fuentes, RLS, aislamiento entre organizaciones, ventanas, conflictos,
reprogramación append-only y auditoría. No requiere Supabase remoto.
